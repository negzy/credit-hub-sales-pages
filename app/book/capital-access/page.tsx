...
export const metadata: Metadata = {
  title: "Book: Capital Access DFY | The Credit Hub",
  description: "Schedule a call to get started with Done-For-You funding.",
};

export default function BookCapitalAccessPage() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <header className="text-center">
          <h1 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Book: Capital Access DFY
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-lg text-gray-400">
            Schedule a call to get started with Done-For-You funding. We’ll walk through your situation and next steps.
          </p>
          <div
        ...
        <div className="mt-10 w-full">
          <CalEmbed calLink={LINKS.cal.capitalAccess} className="rounded-xl" />
        </div>
