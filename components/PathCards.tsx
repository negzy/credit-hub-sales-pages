...
const CARDS = [
  {
    ...
    items: [
      ...
      { name: "Community Growth & Skool scaling", detail: "Strategies to grow and scale your community." },
      { name: "Lender Vault", detail: "1,700+ banks database with bureau insights and approval patterns." },
      { name: "Pulse App", detail: "Free access: track engagement + schedule posts." },
    ],
    cta: "Join Premium",
  ...
  },
  {
    ...
    icon: <IconMentorship />,
    title: "Evolution",
    price: "$997/mo for 4 months",
    tagline: "Implementation program with Emmanuel—real systems, real execution",
    description: "4-month program to build or scale a funding business. Funding business strategy, offer positioning, CRM and pipeline setup, lender strategy, community growth, weekly implementation support, and access to private resources and systems.",
    items: [],
